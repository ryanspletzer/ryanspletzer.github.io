...
Clayton Christensen's thesis wasn't that big companies are dumb or poorly managed—it's
...
GitHub Copilot launched as a technical preview in June 2021.
(Sidenote: this was way schockingly earlier than I realized or recalled.)
...
Then Cursor showed up in March 2023.
...
GitHub Copilot Chat didn't reach general availability until December 2023—nine months later.
Cursor had codebase-wide context from day one.
Cursor introduced agent mode in late 2024; GitHub's version landed in February 2025.
One analysis noted that Copilot's multi-file edits feature was "heavily inspired by another editor called Cursor."

The pattern repeats in terminal tools.
Aider pioneered CLI-based agentic coding in 2023.
...
Meanwhile, GitHub Copilot's market share collapsed from near-100% to roughly 42% in twelve months.
Cursor crossed $1 billion ARR faster than any B2B software company in history.

---

## The Copying Game

Amjad Masad, Replit's CEO, described the dynamic with remarkable candor:
...
Satya Nadella reportedly told employees that Microsoft's size is a "massive disadvantage."
In a December 2024 internal email, he criticized Copilot programs as not "really work[ing]" and being "not smart."

Thomas Dohmke, GitHub's CEO, admitted in hindsight:
...
and put out various edicts like the API mandate that forced all teams have service APIs that others can use,
...
Research suggests innovation timelines are delayed 30-50% on average
by approval processes and organizational complexity.
Technical debt may represent up to 40% of technology estate in large enterprises.
...
It can work.
Microsoft has 20 million Copilot users and 90% of Fortune 100 companies as customers.
...
Research by Golder and Tellis, analyzing 500 companies across 50 product categories, found that 47% of first movers failed versus only 8% of fast followers.
Steve Blank put it bluntly:
...
VS Code still holds 75.9% market share among developers.
...
Michael Truell, Cursor's CEO, articulated the bet:
...
Competition has unambiguously benefited developers.
GitHub Copilot now has a free tier.
Amazon CodeWhisperer is free for individuals.
