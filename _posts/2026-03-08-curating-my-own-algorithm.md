...
When I finally left,
I had a realization that stung a little:
...
Today I only have a handful of social media accounts—LinkedIn,
[Bluesky](https://bsky.app/), and [Mastodon](https://hachyderm.io/)—and
I only post to them when I share something I've written.
I don't have any of those apps on my phone.
That one change alone has been significant for my mental health and focus,
and I find myself with more time and energy for creative work like programming and writing.

## The Problem with Algorithms

Algorithms are a mixed bag.
Some are so good at figuring out what you want that they become addicting.
TikTok's algorithm, for example, is remarkable—it
has a level of randomness that takes you into interesting adjacent content
...
but it's buried in a sea of slop.

Bluesky and Mastodon feel relatively un-algorithmized by comparison,
which is refreshing.

## RSS: My Personal Feed

My solution to all of this is RSS.
...
If you remember Google Reader, this is the closest thing to getting that experience back.
...
is either garbage or just there to stoke fear.
...
and what's valuable to me might not be what's valuable to you.
...
So when I find someone who consistently shares valuable thinking,
I go find their actual website and subscribe via RSS.
LinkedIn becomes a discovery mechanism;
RSS becomes the reliable delivery mechanism.
...
6. **Give it time.**
   ...
   you'll find yourself instinctively with muscle memory and reflex
   reaching your thumb to where those apps used to be
   in your phone's app grid / folders—I
   found that that subsides after a few days to a week.

That's my information diet.
No algorithms, no doomscrolling, no slop.
Just a curated feed of things worth reading from people worth listening to.
